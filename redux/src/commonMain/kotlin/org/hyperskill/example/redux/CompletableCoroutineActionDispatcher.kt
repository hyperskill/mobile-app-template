 ...
 */
abstract class CompletableCoroutineActionDispatcher<Action, Message>(
    ...
    /**
     * Represents [CoroutineScope] config for operations that should be completed even after scope cancellation.
